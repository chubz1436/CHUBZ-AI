...
describe("M2 migration rollback evidence completion", () => {
  it("rolls back a failing migration and never records its version marker", () => {
    ...
    db.exec("DROP TRIGGER m10_confirmation_immutable_delete; DROP TRIGGER m10_confirmation_immutable_update; DROP TRIGGER m10_recommendation_finalized_guard; DROP TRIGGER m10_quota_immutable_delete; DROP TRIGGER m10_quota_immutable_update; DROP TABLE m10_route_confirmations; DROP TABLE m10_fallback_plans; DROP TABLE m10_candidate_evaluations; DROP TABLE m10_recommendations; DROP TABLE m10_routing_incidents; DROP TABLE m10_routing_requests; DROP TABLE m10_reconciliation_runs; DROP TABLE m10_mutations; DROP TABLE m10_health_observations; DROP TABLE m10_quota_observations; DROP TABLE m10_routing_policies; DROP TRIGGER m9_finalized_promotion_evidence_guard; DROP TRIGGER m9_finalized_prepare_evidence_guard; DROP TRIGGER m9_apply_evidence_immutable_delete; DROP TRIGGER m9_apply_evidence_immutable_update; DROP TRIGGER m9_repository_binding_path_immutable; DROP TABLE m9_mutations; DROP TABLE m9_apply_evidence; DROP TABLE m9_capability_grants; DROP TABLE m9_apply_requests; DROP TABLE m9_repository_bindings; DROP TABLE m8_mutations; DROP TABLE m8_bridge_state; DROP TABLE m8_reconciliation_runs; DROP TABLE m8_stop_operations; DROP TABLE m8_emergency_state; DROP TABLE m8_emergency_stops; DROP TABLE m8_recovery_incidents; DROP TABLE m8_projection_state; DROP TABLE m8_operational_events; DROP TRIGGER administrators_singleton_insert; DROP TRIGGER m7_review_packages_immutable_update; DROP TRIGGER m7_review_packages_immutable_delete; DROP TRIGGER m6_manual_results_immutable_update; DROP TRIGGER m6_manual_results_immutable_delete; DROP TABLE m7_review_packages; DROP TABLE m7_capture_requests; DROP TABLE m7_mutations; DROP TABLE administrator_singleton_guard; DROP TABLE m6_manual_results; DROP TABLE m6_mutations; DROP TABLE m5_worker_states; DROP TABLE m5_adapter_readiness; DELETE FROM schema_migrations WHERE version IN (2, 3, 4, 5, 6, 7, 8, 9, 10)");
